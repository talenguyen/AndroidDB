...
final class ProcessorLogger {
    private final Messager messenger;

    ProcessorLogger(Messager messenger) {
        this.messenger = messenger;
    }

    /**
     * Print out debug logs, will only print if {@link AndroidDBProcessor#DEBUG}
     * is true.
     */
    void d(String message, Object... args) {
        if (AndroidDBProcessor.DEBUG) {
